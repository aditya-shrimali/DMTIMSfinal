...
import AlumniBanner from "../components/AlumniBanner/AlumniBanner";
  ...
  return (
    <div className="cursor-default">
      <Head>
        ...
        <meta property="og:url" content="https://dmtims.edu.in/alumni" />
        ...
        <meta property="twitter:url" content="https://dmtims.edu.in/alumni" />
