    ...
    <section className="relative bg-white">
      <div className="flex flex-col px-4 ">
        <div className="mx-auto w-full max-w-screen-2xl py-4 lg:my-4  ">
          ...
          {/* director1 */}
          <p className="dmtims-subtitle text-lg  pb-0 font-bold text-[#ED1C24] sm:text-3xl md:text-5xl ">
            From the Desk of Executive Director - VES Trust
          </p>

          <div className="grid grid-cols-1 gap-4 pt-2 lg:grid-cols-2  lg:gap-0 ">
            <div>
              <div className="flex flex-col   ">
                <div
          ...
          {/* director2 */}
          <p className="dmtims-subtitle text-lg  pb-0 pt-2 font-bold text-[#ED1C24] sm:text-3xl md:text-5xl ">
          ...
          xl:space-x-56">
            ...
            <div className="flex flex-col  lg:order-last order-first mt-4 lg:mt-0 ">
              <div className="relative mt-auto h-[250px] w-full  sm:h-[300px] md:h-[350px] lg:h-[450px] ">
                <div className="flex w-full bg-slate-600 lg:hidden">
                  <Image
                    priority
                    src={director2}
                ...
                <div className="hidden h-[330px]  pt-8 w-full  lg:flex  ">
                  <Image priority src={director2} alt="santosh varghese"
          ...
          {/* director3 */}
        <div>
          <p className="dmtims-subtitle text-lg  py-2 pb-0 font-bold text-[#ED1C24] sm:text-3xl md:text-5xl">
            From the desk of Director - DMTIMS
          </p>
          <div className="grid grid-cols-1 gap-4 pt-4 lg:grid-cols-2  lg:gap-0">
            <div>
              <div className="flex flex-col">
